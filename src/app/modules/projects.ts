export const projects = [
  {
    ...
    eps: [
      ...
      { title: 'O Site', link: 'https://youtu.be/U4XHuaKnym4', img: 'ep3.jpg' },
      { title: 'O Podcast', link: 'https://youtu.be/Pc1ljOusEhE', img: 'ep4.jpg' },
      { title: 'A Dinâmica', link: 'https://youtu.be/kShQVOzfcTA', img: 'ep5.jpg' },
      { title: 'A Tapioca', link: 'https://youtu.be/h0zkVQSyFwg', img: 'ep6.jpg' },
      { title: 'O Rival', link: 'https://youtu.be/VYx8EMdbcL0', img: 'ep7.jpg' },
      { title: 'O Halloween', link: 'https://youtu.be/U0AoXq7lI1I', img: 'ep8.jpg' },
      { title: 'O Youtuber', link: 'https://youtu.be/BLN-sLwDM0c', img: 'ep9.jpg' },
      { title: 'A Crise', link: 'https://youtu.be/QcSTMKdbW8I', img: 'ep10.jpg' },
    ],
  },
  {
  ...
  {
    projectName: 'Vovó 001',
    isHome: true,
    category: 'HQ',
    image: 'placeholder.png',
    banner: 'banner-home.jpg',
    sinopse: 'Rose é uma senhora de 60 anos, ex-militar e vó de duas crianças. Ela é convidada pelo governo para se tornar espiã, pois foi concluído após discussões que uma senhorinha passaria despercebida. A principio Rose recusa a oferta, mas muda de ideia quando vê que pode mandar sua vizinha fofoqueira morar longe dela.',
    type: 'Aventura, Comédia, Mistério e Ação',
    format: 'HQ',
    qtd: '',
    images: ['', ''],
